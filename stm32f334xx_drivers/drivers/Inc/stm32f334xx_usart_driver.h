...
#ifndef INC_STM32F334XX_USART_DRIVER_H_
#define INC_STM32F334XX_USART_DRIVER_H_

#include "stm32f334xx.h"

/*
 * This is a Configuration structure for USART communication
*/
typedef struct
{
...
/*
 * This is a Handle structure for USART communication
*/
typedef struct
{
    // Pointer to hold the base address of the USART peripheral
    USART_RegDef_t      *pUSARTx;                                          /*!< This holds the base address of the USART peripheral >*/
...
#endif /* INC_STM32F334XX_USART_DRIVER_H_ */
